...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            ...
            <br><br>
            <span>Socrates</span> claimed teach nothing, but he told everyone that he believed knowledge was virtue. He questioned every idea that Ancient Greeks believed thought were true, from the gods to the law to why the sun rises and sets. Do you question everything in the search for knowledge and virtue as your Socrates did?</div>`;
