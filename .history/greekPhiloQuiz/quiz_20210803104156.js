...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            results.innerHTML = `<div class='results'>You were <span>Pythagoras</span>!  You created a closed community with like minded people, and together, you vowed that you would never speak about what you learned or did there. With your brethren you practiced music, wrestling, and the mystic art of numbers.</div> 
            <br><br>
            <div class='results'><span>Pythagoras</span> believed that when the body died, the soul moved on to another body and claimed that he was once the son of the god Hermes.</div> 
            <br>
            <div class='results'>Who were you in your past life? Maybe you were Pythagoras himself!</div>`;
        } else if(socr > pyth && socr > ari) {
            results.innerHTML = `<div class='results'>You were <span>Socrates</span>! You were one of the ugliest men Ancient Greece had ever seen, but something about your wisdom drew others in to listen to your words.</div> 
            <br>
            <div class='results'><span>Socrates</span> claimed teach nothing, but he told everyone that he believed knowledge was virtue. He questioned every idea that Ancient Greeks believed, from the gods to the law to why the sun rises and sets.</div> 
            <br>
            <div class='results'>Do you question everything in the search for knowledge and virtue as Socrates did?</div>`;
        } else if(ari > pyth && ari > socr) {
            results.innerHTML = `<div class='results'>You were <span>Aristotle</span>. You were a student of Plato and learned from him about Socrates' logical questioning. Not only did you question, you also searched for the answers. He used the first forms of the scientific method to study the world.</div> 
            <br>
            <div class='results'><span>Aristotle</span> was the tutor of Alexander the Great who, while out on war campaigns, gathered animal and plant specimens for his beloved teacher to study. With the knowledge he gathered, Aristotle created a library full of knowledge that forever changed the course of science.</div> 
            <br>
            <div class='results'>Do you study the world around you with the same thirst for knowledge?</div>`;
        } else {
            results.innerHTML = `<div class='results'>You were never one of The Ancient Greek Philosophers. Perhaps you should start your own school of philosophy! So, go ahead, grab your tools, build a time machine, and teach those Ancient Greeks your new crazy, philosophical ideas!</div>`;
        }
