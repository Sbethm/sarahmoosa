...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            ...
            <br><br>
            <span>Aristotle</span> was the tutor of Alexander the Great who, while out on war campaigns, gathered animal and plant specimens for his beloved teacher to study. With the knowledge he gathered, Aristotle created a library full of knowledge that forever changed . 
            <br><br>
