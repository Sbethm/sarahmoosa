...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            ...
            <br><br>
            <div class='results'><span>Pythagoras</span> believed that when the body died, the soul moved on to another body and claimed that he was once the son of the god Hermes. 
            <br><br>
