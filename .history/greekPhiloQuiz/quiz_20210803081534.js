...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            results.innerHTML = `<div class='results'>You were <span>Pythagoras</span>.  When he invited you into his closed community, you vowed that you would never speak about what you learned or did there. Together, with your brethren you practiced music, wrestling, and the mystic art of numbers. Pythagoras believed that when the body died, the soul moved on to another body and claimed that he was once the son of the god Hermes. Who were you in your past lives? Maybe you were Pythagoras himself!</div>`;
