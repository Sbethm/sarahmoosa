...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            ...
            results.innerHTML = `<div class='results'>You were <span>Socrates</span>! You were one of the ugliest men you have ever seen, but something about his personality draws you in to listen to his words. He teaches nothing, but he tells everyone that he believes knowledge is virtue. He has taught you to question every idea that you once thought were true, from the gods to the law to why the sun rises and sets. Do you question everything in the search for knowledge and virtue as your Socrates did?</div>`;
