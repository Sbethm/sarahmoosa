...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            results.innerHTML = `<div class='results'>You were <span>Pythagoras</span>!  You created a closed community with your followers, and together, you vowed that you would never speak about what you learned or did there. With your brethren you practiced music, wrestling, and the mystic art of numbers. 
            <br><br>
